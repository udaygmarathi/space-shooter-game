...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0,"CANARA ENGINEERING COLLEGE");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-700, 385, 0.0,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
		glColor3f(0.0, 0.0, 1.0);
	displayRasterText(-500, 300, 0.0,"A MINI PROJECT ON COMPUTER GRAPHICS");
	...
	displayRasterText(-125, 225, 0.0,"Space Shooter");
	  ...
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," Uday G M");
	displayRasterText(-800, -285, 0.0," Shreyas K S");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of ");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Mrs Sukshma");
		glColor3f(1.0, 0.0, 0.0);
